...
public class PIPPanel extends JPanel implements MouseListener, MouseMotionListener {
	...
	private final AbstractGraphView view;

	public PIPPanel(AbstractGraphView view2) {
	...
	public synchronized void mouseReleased(MouseEvent e) {
		if (SwingUtilities.isRightMouseButton(e)) {
			...
			double w = Math.max(view.getViewport().getExtentSize().getWidth() * f, lastRect.getWidth())
					/ lastRect.getWidth();
